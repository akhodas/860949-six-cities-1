              ...
              <div className="property__gallery-container container">
                <div className="property__gallery">
                  {this.images.map((image) => (
                    <div key={image + this.room.id} className="property__image-wrapper">
                ...
                <div className="property__wrapper">
                  ...
                  <div className="property__rating rating">
                    <div className="property__stars rating__stars">
                      <span style={{width: `${100 * this.room.rating / 5}%`}}></span>
                      <span className="visually-hidden">Rating</span>
                    </div>
                    <span className="property__rating-value rating__value">{this.room.rating}</span>
                  </div>
                  <ul className="property__features">
                    ...
                    <li className="property__feature property__feature--bedrooms">
                      {this.room.bedrooms} Bedrooms
                    </li>
                    <li className="property__feature property__feature--adults">
                      Max {this.room.maxAdults} adults
                    </li>
                  </ul>
                  <div className="property__price">
                    <b className="property__price-value">&euro;{this.room.price}</b>
                    <span className="property__price-text">&nbsp;night</span>
                  </div>
                  <div className="property__inside">
                    <h2 className="property__inside-title">What&apos;s inside</h2>
                    <ul className="property__inside-list">
                      {this.room.goods.map((item) => (
                        <li key={item + this.room.id} className="property__inside-item">
                          {item}
                        </li>
                      ))}
                    </ul>
